        ...
        <Card>
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-amber-500/10 flex items-center justify-center text-amber-600">
              <Icon name="pending_actions" className="h-6 w-6" />
            </div>
            <div>
        ...
        <Card>
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-green-500/10 flex items-center justify-center text-green-600">
              <Icon name="task_alt" className="h-6 w-6" />
            </div>
            <div>
        ...
        <Card className="lg:col-span-2">
          ...
          {loading ? (
            ...
            <div className="py-12 text-center text-slate-500 bg-slate-50 rounded-xl border border-dashed border-slate-200">
              <Icon name="description" className="mx-auto mb-2 h-10 w-10 text-slate-300" />
        ...
        <Card>
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-100 flex gap-4">
              <Icon name="info" className="h-5 w-5 shrink-0 text-blue-500" />
              <div>
