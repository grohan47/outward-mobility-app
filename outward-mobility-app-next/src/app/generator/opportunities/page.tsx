    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <Card className="py-20 text-center text-slate-500">
          <Icon name="explore_off" className="mx-auto mb-4 h-10 w-10 text-slate-300" />
                  ...
                  <ul className="mb-3 space-y-1">
                    {opp.ai_ctas.slice(0, 2).map((cta) => (
                      <li key={cta} className="text-xs text-slate-600 flex items-start gap-1.5">
                        <Icon name="auto_awesome" className="mt-[1px] h-3.5 w-3.5 text-primary" />
                        <span>{cta}</span>
                      </li>
                    ))}
                  </ul>
          ...
          <div className="min-h-full flex items-center justify-center">
            ...
            >
              <div className="relative">
                ...
                >
                  <Icon name="close" className="h-5 w-5 text-slate-600" />
                </button>
              </div>
