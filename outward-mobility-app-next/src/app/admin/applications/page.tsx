    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-2">Master view of all approval requests across configured workflows.</p>
        </div>
        <Link
          href="/admin/messages"
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden p-2">
        {loading ? (
          <div className="p-12 text-center text-slate-400 flex flex-col items-center">
            <Icon name="progress_activity" className="mb-4 h-8 w-8 animate-spin" />
            Loading ledger data...
          </div>
        ) : (
          <Table
