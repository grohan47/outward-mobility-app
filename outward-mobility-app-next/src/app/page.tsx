          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {error && (
              <div className="flex items-start gap-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                <Icon name="error" className="mt-0.5 h-[18px] w-[18px] text-red-500" />
            ...
            >
              {loading ? (
                <>
                  <Icon name="progress_activity" className="h-[18px] w-[18px] animate-spin" />
                  Signing in...
                </>
              ) : (
                <>
                ...
                <div className="flex flex-col gap-2">
                  {groupedUsers.students.map((user) => (
                    ...
                    >
                      ...
                      <Icon name="arrow_forward" className="h-5 w-5 text-transparent transition-colors group-hover:text-primary" />
                    </button>
                  ))}
                </div>
              </div>
